...
def generate_advanced_password(length=12, use_uppercase=True, use_lowercase=True, use_digits=True, use_special=True):
    characters = ""
    if use_uppercase:
...
if st.button("Generate Advanced Password"):
    password = generate_advanced_password(length, use_uppercase, use_lowercase, use_digits, use_special)
    if password:
        st.markdown(f"""
        <div class="glass">
